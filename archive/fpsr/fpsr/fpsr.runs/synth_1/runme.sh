...
HD_PWD='C:/Users/atsykes/fpsr/fpsr/fpsr.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log first_person_second_row_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source first_person_second_row_top.tcl
