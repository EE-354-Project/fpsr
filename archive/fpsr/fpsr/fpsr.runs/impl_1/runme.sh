...
HD_PWD='C:/Users/atsykes/fpsr/fpsr/fpsr.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log first_person_second_row_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source first_person_second_row_top.tcl -notrace
